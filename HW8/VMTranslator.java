...
public class VMTranslator {
    public static void main(String[] args) {
        ...
        if (args.length == 1) {
            ...
            System.out.println("Please enter the assembly file name you would like to assemble.");
            ...
            if (inputFile.isFile()) {
                ...
                fileOutPath = inputFile.getAbsolutePath().substring(0, inputFile.getAbsolutePath().lastIndexOf("."))
                        + ".asm";
            ...
            // Check if the file exists before initializing the CodeWriter
            if (outputFile.exists()) {
                System.out.println("File already exists. Please choose a different file name.");
                System.exit(1);
            }

            // No need for the try-catch block here
